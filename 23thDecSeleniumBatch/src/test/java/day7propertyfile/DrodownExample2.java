...
public class  DrodownExample2  {
	...
	public static void main(String[] args) {
		...
		List<Integer> actualdayList=new ArrayList<Integer>();
		for(int i=1;i<optionList.size();i++) {
			actualdayList.add(Integer.parseInt(optionList.get(i).getText()));
		}		
		List<Integer> expecteddayList=new ArrayList<Integer>(actualdayList);
		Collections.sort(expecteddayList);		
		System.out.println("are getting displayed as expected? "+actualdayList.equals(expecteddayList));
	}

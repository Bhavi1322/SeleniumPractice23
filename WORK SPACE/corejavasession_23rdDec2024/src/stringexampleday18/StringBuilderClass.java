...
public class StringBuilderClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("sb1 and sb2 comparision with address: "+sb1.equals(sb2));//address basis comparison
		System.out.println("sb1 and sb2 comparision with address: "+(sb1==sb2));//address basis comparison
		...
		System.out.println("sb1 and sb2 comparision with value: "+(sb1.toString().equals(sb2.toString())));
	}
